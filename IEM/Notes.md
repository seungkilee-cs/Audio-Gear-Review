...
## LZ A6 (Red)
핏이랑 상관없이 보컬이 매우 멀다. 치찰음이 미친듯이 부각된다. 해상력 자체는 좋다. 분리도는 별로다. 임팩트도 치찰음 때문인지 많이 밀린다. 스테이지는 적당하다. 소리 자체가 꽤 위에 떠있다. 치찰음 대역인 3-7 kHZ가 -3dB인데도 이런 미친 치찰음을 때리는 것을 보면 이건 튜닝이 잘못된거다. 기본기는 좋다. 다른 필터로 테스트 해볼까한다.
